object frmSelEstadoAfiliado: TfrmSelEstadoAfiliado
  Left = 627
  Top = 267
  Width = 242
  Height = 146
  Caption = 'Estado de los afiliados a mostrar'
  Color = clBtnFace
  ...
  object DBLookupComboBox1: TDBLookupComboBox
    ...
    Width = 201
    Height = 24
    KeyField = 'IDESTADOAFILIADO'
    ListField = 'ESTADO'
    ListSource = ds_estadoAfiliado
    TabOrder = 0
  end
  ...
  object ds_estadoAfiliado: TDataSource
    DataSet = DM_AfiliadoAM.qtugEstados
    Left = 96
    Top = 24
  end
end
